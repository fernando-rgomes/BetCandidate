...
export default function Bet() {
  ...
  useEffect(() => {
    ...
    getDispute()
        .then(dispute => {
            setDispute({...dispute,
            image1: "https://amenazare.com.br/wp-content/uploads/2023/12/Endocrinologista-e-Clinico-Geral-Edberto-Quental-1015x1024.jpg", // URL real da imagem de Albino
            image2: "https://blogdomagno.com.br/wp-content/uploads/2023/10/albino.jpeg"
  ...
  return (
    ...
    <div className="container px-4 py-5">
      <div className="row  align-items-center ">
         ...
         <p className="lead">Apostas on-chain nas eleições de Condado-PE.</p>
         {
          dispute.winner == 0
         ? <p className="lead">Você tem até o dia da 06/10 para deixar a sua aposta em um dos candidatos abaixo.</p>
