    ...
    <>
      ...
      <div className="container px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div className="col-6">
            <img src="https://tudobahia.com.br/wp-content/uploads/2020/11/eleicoes-2020-saiba-como-consultar-local-de-votacao-zona-e-secao.jpg" className="d-block mx-lg-auto img-fluid" width="700" height="500" />
          </div>
          <div className="col-6">
